...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || "Λάθος email ή κωδικός. Προσπάθησε ξανά.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="d-flex align-items-center justify-content-center" style={{ minHeight: "100vh", background: "var(--bg-color)" }}>
      ...
      <div className="bento-card p-4 p-md-5 position-relative z-1 shadow-lg" style={{ width: "100%", maxWidth: "420px", background: "var(--card-bg)", border: "1px solid var(--card-border)", borderRadius: "32px", backdropFilter: "blur(20px)" }}>
        ...
        <div className="text-center mb-4">
          <div className="d-inline-flex align-items-center justify-content-center rounded-circle mb-3 shadow-sm" style={{ width: "60px", height: "60px", background: "var(--accent-color)", color: "#000" }}>
            <CompassFill size={30} />
          </div>
