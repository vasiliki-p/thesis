...
router.post("/chatbot", async (req, res) => {
    ...
    try {
        // ΔΙΟΡΘΩΣΗ 1: Προσθέσαμε το location!
        ...
        const systemPrompt = `
          ...
          ΑΥΣΤΗΡΟΙ ΚΑΝΟΝΕΣ: 
          1. Αν ο χρήστης ζητήσει κάτι σε μια πόλη/περιοχή που ΔΕΝ ΥΠΑΡΧΕΙ στις διαθέσιμες δραστηριότητες, πες του ΕΥΓΕΝΙΚΑ ότι δεν έχεις ακόμα προτάσεις για εκείνη την περιοχή και πρότεινέ του μια άλλη.
          2. ΠΟΤΕ μην προτείνεις δραστηριότητα για μια περιοχή αν ανήκει σε άλλη.
          3. Όταν προτείνεις κάτι, βάλε στο τέλος το tag: {{LINK:/activities/ID}}. Μπορείς να βάλεις πολλαπλά tags αν έχεις πολλές προτάσεις.
          4. Απάντησε στα Ελληνικά, σύντομα και φιλικά.
        `;
        ...
        const response = await groq.chat.completions.create({
            ...
            temperature: 0.2 // Χαμηλό temperature για να μην "φαντάζεται" πράγματα
        });
